                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                <ul id="addNewBookId" className="dropdown-menu" aria-labelledby='dropdownMenuButton1'>
                                    <li><a onClick={() => { categoryField('FE') }}>Front end</a></li>
                                    <li><a onClick={() => { categoryField('BE') }}>Back end</a></li>
                                    <li><a onClick={() => { categoryField('Data') }}>Data</a></li>
                                    <li><a onClick={() => { categoryField('DevOps') }}>DevOps</a></li>
                                </ul>
                            </div>
                        </div>
